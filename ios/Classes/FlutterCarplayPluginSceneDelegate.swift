...
class FlutterCarPlaySceneDelegate: UIResponder, CPTemplateApplicationSceneDelegate {
  ...
  func sceneDidEnterBackground(_ scene: UIScene) {
    MemoryLogger.shared.appendEvent("carplay entered background.")
  ...
  func templateApplicationScene(_ templateApplicationScene: CPTemplateApplicationScene,
    ...
    MemoryLogger.shared.appendEvent("templateApplicationScene didConnect")
  ...
  func templateApplicationScene(_ templateApplicationScene: CPTemplateApplicationScene,
    ...
    MemoryLogger.shared.appendEvent("templateApplicationScene didDisconnect")
    //FlutterCarPlaySceneDelegate.interfaceController = nil
  }
  ...
  func templateApplicationScene(_ templateApplicationScene: CPTemplateApplicationScene,
    ...
    MemoryLogger.shared.appendEvent("templateApplicationScene didDisconnectInterfaceController")
    //FlutterCarPlaySceneDelegate.interfaceController = nil
  }
}
